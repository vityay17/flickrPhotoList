...
public class FlickrPhotoListApp {

    private static final Logger log = LoggerFactory.getLogger(FlickrPhotoListApp.class);

    private final Environment env;

    public FlickrPhotoListApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes flickrPhotoList.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(FlickrPhotoListApp.class);
